...
当前项目还在早期打磨阶段。源码暂不开放，但已经提供 Docker 本地体验包，方便技术用户、早期试用用户和对 AI 短剧工作流感兴趣的朋友先看产品形态、跑一跑体验流程、进群反馈问题。
...
- 它由一名独立开发者完整推进，从产品设计、前端、后端、云端服务、体验包到测试群都在持续迭代。
...
- 正在观察 AI 视频工具、短剧工作流、内容生产工具新方向的团队或个人。

## 下载本地体验包

如果你想先在自己的电脑上看看产品形态，可以下载 Docker 本地体验包。

这个包适合用来快速体验优扬短剧的界面、创作入口和工作流结构。它不是完整源码自部署版，而是一个本地体验包，核心生成能力和服务调度由官方服务提供。
...
从产品想法、界面设计、前后端实现、云端服务、本地体验包、GitHub 展示页到测试群反馈，都是围绕一个目标推进：把 AI 短剧创作从“会写提示词的人才能玩”，变成更多普通创作者也能理解、进入和持续使用的工作流。
...
- 面向团队、工作室、MCN、内容账号的早期试用和真实场景反馈
- 后续视产品成熟度，开放部分基础能力展示版给社区

## 交流方向

如果你正在做短剧、AI 视频、内容账号、MCN 或自动化内容生产，也欢迎进群交流真实体验和使用想法。
